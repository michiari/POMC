...
Precedence-Oriented Temporal Logic (POTL) \cite{ChiariMP21} is a temporal
...
It consists of a bounded SMT encoding of a tree-shaped tableau for POTL.
...
It requires the development files for the Z3 Theorem Prover library to be built
(package \verb|libz3-dev| on Debian-based systems).
